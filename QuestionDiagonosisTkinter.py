...
#        master.minsize(700,350)
    ...
    def createWidget(self):
        self.lblQuestion=Label(self,text="Question",width=12,bg="#FCFB88")
        self.lblQuestion.grid(row=0,column=0,rowspan=4)

        self.lblDigonosis = Label(self, text="Digonosis",width=12,bg="#FCFB88")
        ...
        self.btnNo=Button(self,text="No",width=12,bg="#FCFB88", command=self.btnNo_Click)
        self.btnNo.grid(row=25,column=0)
        self.btnYes = Button(self, text="Yes",width=12,bg="#FCFB88", command=self.btnYes_Click)
        self.btnYes.grid(row=25, column=1,columnspan=20,sticky="e")

        self.btnClear = Button(self, text="Clear",width=12,bg="#3E67F7", command=self.btnClear_Click)
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self, text="Start",width=12,bg="#3E67F7", command=self.btnStart_Click)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="HEALTH CARE CHATBOT", bg="#D4DB02", width="300", height="2", font=("Berlin Sans FB Demi", 13))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="2", width="300", font=("Berlin Sans FB Demi", 13), command = self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="2", width="300",  font=("Berlin Sans FB Demi", 13) ,command = self.btnRegister_Click)
        self.btnRegister.pack()
        self.lblTeam=Label(self, text="Made By Students of SAKEC Under Guidance Of Milind Khairnar:", bg="slateblue4", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Aditya Jadhav    SE4_16", bg="#5BC4C7", width = "250", height = "1", font=("Berlin Sans FB Demi", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Aryan Jagani     SE4_17", bg="#D156CE", width = "250", height = "1", font=("Berlin Sans FB Demi", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Swarali Janaskar SE4_18", bg="#5BC4C7", width = "250", height = "1", font=("Berlin Sans FB Demi", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="Dhruvi Joshi     SE4_20", bg="#D156CE", width = "250", height = "1", font=("Berlin Sans FB Demi", 13))
        self.lblTeam4.pack()
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="#A3CF73")
        self.lblMsg.pack()
        ...
        self.btnLogin=Button(self, text="Login", width=10, height=1,bg="#A3CF73", command=self.btnLogin_Click)
        self.btnLogin.pack()
...
class SignUp(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below", bg="#A3CF73")
        self.lblMsg.pack()
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=1, bg="#A3CF73", command=self.register_user)
        self.btnRegister.pack()
